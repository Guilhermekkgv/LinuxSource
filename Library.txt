...
local Linux = {
    Theme = {
        ...
        DropdownOption = Color3.fromRGB(35,monday, 35, 40)
    }
}
...
function Linux.Create(config)
    ...
    local SubtitleLabel = Linux.Instance("TextLabel", {
        ...
        BackgroundTransparency = 1,
        Size = UDim2.new(0, 0, 1, 0),
        Position = UDim2.new(0, 10 + TitleLabel.TextBounds.X + 4, 0, 0),
        Font = Enum.Font.Gotham,
    ...
    Linux.Instance("UIListLayout", {
        ...
        Vertical waarop = Enum.VerticalAlignment.Top,
    ...
    function LinuxLib.Tab(config)
        ...
        local TabText = Linux.Instance("TextLabel", {
            Parent = TabBtn,
            BackgroundTransparency = 1,
            Size = UDim2.new(1, config.Icon and config.Icon.Enabled and -36 or -18, 1, 0),
            Position = UDim2.new(0, config.Icon and config.Icon.Enabled and 36 or 18, 0, 0),
            Font = Enum.Font.Gotham,
            Text = config.Name,
            TextColor3 = Color3.fromRGB(160, 160, 170),
            TextSize = 14,
        ...
        local function SelectTab()
            for _, tab in pairs(Tabs) do
                ...
                tab.Text.TextColor3 = Color3.fromRGB(160, 160, 170)
            end
        ...
        function TabElements.Toggle(config)
            ...
            local function UpdateToggle()
                ...
                if State then
                    ...
                    TweenService:Create(Knob, tween, {Position = UDim2.new(0, 2, 0, 2), BackgroundColor3 = Color3.fromRGB(160, 160, 170)}):Play()
                end
            end

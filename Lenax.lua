...
local Linux = {
    Theme = {
        Background = Color3.fromRGB(18, 18, 20), -- Fundo mais escuro, elegante
        Element = Color3.fromRGB(28, 28, 32),    -- Elementos com leve contraste
        Accent = Color3.fromRGB(0, 170, 255),    -- Azul neon elegante como destaque
        Text = Color3.fromRGB(220, 220, 230),    -- Texto claro, fácil de ler
        Toggle = Color3.fromRGB(38, 38, 45),     -- Toggle com leve relevo
        TabInactive = Color3.fromRGB(24, 24, 28),-- Tabs não ativas mais discretas
        DropdownOption = Color3.fromRGB(33, 33, 38), -- Opções com leve sombra
    }
}

...
function Linux.Create(config)
    ...
    local IntroScreen = Linux.Instance("Frame", {
        Parent = LinuxUI,
        BackgroundColor3 = Linux.Theme.Background,
    ...
    local LoadingBarFrame = Linux.Instance("Frame", {
        Parent = IntroScreen,
    ...
    local LoadingBarFill = Linux.Instance("Frame", {
        Parent = LoadingBarFrame,
    ...
    local function PlayIntro(callback)
        local fadeInTitle = TweenInfo.new(1, Enum.EasingStyle.Sine, Enum.EasingDirection.In)
        local moveTitle = TweenInfo.new(1, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
        local fillBar = TweenInfo.new(2, Enum.EasingStyle.Linear)
        local fadeOut = TweenInfo.new(0.5, Enum.EasingStyle.Sine, Enum.EasingDirection.Out)

        TweenService:Create(IntroTitle, fadeInTitle, {TextTransparency = 0}):Play()
        TweenService:Create(IntroTitle, moveTitle, {Position = UDim2.new(0.5, 0, 0.35, 0)}):Play()

        task.wait(0.5)

        TweenService:Create(LoadingBarFill, fillBar, {Size = UDim2.new(1, 0, 1, 0)}):Play()

        task.wait(2.5)

        TweenService:Create(IntroScreen, fadeOut, {BackgroundTransparency = 1}):Play()
        TweenService:Create(IntroTitle, fadeOut, {TextTransparency = 1}):Play()
        TweenService:Create(LoadingBarFrame, fadeOut, {BackgroundTransparency = 1}):Play()
        TweenService:Create(LoadingBarFill, fadeOut, {BackgroundTransparency = 1}):Play()
